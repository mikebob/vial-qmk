...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {	
 [_BASE] = LAYOUT_split_3x6_3(
       ...
       KC_LSFT,           KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,            KC_N,           KC_M,       KC_COMMA,         KC_DOT,       KC_SLASH,       LALT_ENT,
                                                       KC_LGUI,      MO(_FIRST),       HYPR_SPC,        KC_LOPT,    RSE_LEADER,        KC_LCTL
),
[_FIRST] = LAYOUT_split_3x6_3(

       _______, LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), LSFT(KC_4), LSFT(KC_5),         LSFT(KC_6),     LSFT(KC_7),     LSFT(KC_8),     LSFT(KC_9),     LSFT(KC_0),        KC_BSPC,
       ...
       KC_LCTL, KC_6, KC_7, KC_8, KC_9, KC_0,                                       LSFT(KC_MINS), LSFT(KC_EQL),  LSFT(KC_LBRC),  LSFT(KC_RBRC),  LSFT(KC_BSLS), LSFT(KC_GRAVE),
                                                       _______,        _______,       _______,          RGB_MOD,        KC_TRNS,        KC_RALT
),
[_SECOND] = LAYOUT_split_3x6_3(

       _______,           KC_1,           KC_2,           KC_3,           KC_4,           KC_5,            KC_6,           KC_7,           KC_8,           KC_9,           KC_0,      KC_DELETE,
       KC_LCTL,        RGB_M_P,        RGB_M_B,        RGB_M_R,       RGB_M_SW,       RGB_M_SN,         KC_LEFT,        KC_DOWN,          KC_UP,       KC_RIGHT,        KC_PGUP,          KC_NO,
       KC_LSFT,        RGB_M_K,        RGB_M_X,        RGB_M_G,        RGB_M_T,          KC_NO,           KC_NO,          KC_NO,          KC_NO,          KC_NO,        KC_PGDN,          KC_NO,
